...
![DNS1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/dns1.png?raw=true)

2. 早些年网页采用http方式传输, 网页没有加密. 后来基于TLS加密技术的https方式传送,网页就被加密无法看到传送的内容了. 如下图
![DNS2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/dns2.png?raw=true)

3. 网页传输 http未加密 与 https加密 对比图. 可以看到内容已被加密
![HTTPS1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/https1.png?raw=true)
...
![DNS3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/dns3.png?raw=true)
...
![Chrome1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/chrome1.png?raw=true)
![Chrome2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/chrome2.png?raw=true)
...
![Chrome3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/chrome3.png?raw=true)
...
AdGuardHome](https://ghproxy.com/https://github.com/AdguardTeam/AdGuardHome). 具体方法请看[搭建自己的DNS服务器](#搭建自己的DNS服务器).
...
![Firefox1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefox1.png?raw=true)
![Firefox2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefox2.png?raw=true)

3. 在打开的对话框中，在最下面, 选中 "启用基于 HTTPS 的 DNS", 然后在下拉框可以选择Cloudflare 默认值或自定义的DOT服务器 .  [如何验证是否开启DOT和ESNI](#测试是否开启DOT和ESNI ).
![Firefox3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefox3.png?raw=true)
...
![Firefox1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefoxesni1.png?raw=true)
![Firefox2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefoxesni2.png?raw=true)

3. 然后选择 "布尔" 类型, 点击右边 + 号, 然后点击右边按钮 将值设为true, 完成.  [如何验证是否开启DOT和ESNI](#测试是否开启DOT和ESNI ).
![Firefox3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/firefoxesni3.png?raw=true)
...
![CF1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/cfcheck1.png?raw=true)

2. 查看结果. 目前Chrome 还不支持ESNI,估计很快就会支持.
![CF2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/cfcheck2.png?raw=true)
...
![CF3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/cfcheck3.png?raw=true)
...
3. 具体设置请参考 [AdGuardHome 官方网站](https://ghproxy.com/https://github.com/AdguardTeam/AdGuardHome). 本脚本已经自动添加了针对中国网站的广告屏蔽规则.
...
![mosdns1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/mosdns1.png?raw=true)
...
![mosdns2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/mosdns2.png?raw=true)
![mosdns3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/mosdns3.png?raw=true)
![mosdns4](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/mosdns4.png?raw=true)
...
![mosdns5](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/mosdns5.png?raw=true)

10. 具体参数可以参考官方网站 https://ghproxy.com/https://github.com/IrineSistiana/mosdns-cn 和 https://ghproxy.com/https://github.com/IrineSistiana/mosdns
