...
![功能列表](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/readme_en.png?raw=true)

![功能列表2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/readme2_en.png?raw=true)

![功能列表3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/readme3_en.png?raw=true)
...
1. Firstly, prefer run this script with root user. Because linux kernel installation need root privileges. And to get SSL with acme.sh also need root privileges. [acme.sh instruction](https://ghproxy.com/https://github.com/acmesh-official/acme.sh/wiki/sudo).
...
![注意 cloudflare CDN](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/docs/cloudflare1.jpg?raw=true)
...
1. https://ghproxy.com/https://github.com/sprov065/v2-ui
2. https://ghproxy.com/https://github.com/Jrohy/trojan
3. https://ghproxy.com/https://github.com/v2fly/v2ray-core
4. https://ghproxy.com/https://github.com/XTLS/Xray-core
5. https://ghproxy.com/https://github.com/trojan-gfw/trojan
6. https://ghproxy.com/https://github.com/p4gefau1t/trojan-go
7. https://ghproxy.com/https://github.com/ylx2016/Linux-NetSpeed
