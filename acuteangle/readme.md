...
![pve1](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/acuteangle/pve1.jpg?raw=true)


4. 继续安装过程, 在第二次提示你可以输入命令的时候输入命令 vi /usr/bin/proxinstall. 编辑文件（或者使用其他文字编辑器如 nano）.
![pve2](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/acuteangle/pve2.jpg?raw=true)
...
![pve3](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/acuteangle/pve3.jpg?raw=true)
...
![pve9](https://ghproxy.com/https://github.com/jinwyp/one_click_script/blob/master/acuteangle/pve9.jpg?raw=true)
