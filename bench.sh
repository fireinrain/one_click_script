...
# https://ghproxy.com/https://github.com/teddysun/across/blob/master/bench.sh
#
...
speed() {
    ...
    speed_test '18837' 'Hongkong, BGP'
    speed_test '16176' 'Hongkong, HGC'
    speed_test '6527'  'Seoul, KR'
    speed_test '7311'  'Singapore, SG'
    speed_test '18831' 'Singapore, BGP'
    speed_test '20637' 'Singapore, OVH'
    speed_test '21569' 'Tokyo, i3D'
    speed_test '15977' 'Tokyo, JP'
}
