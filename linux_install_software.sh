...
function installDocker(){
    ...
    if [[ -s "/usr/local/bin/docker-compose" ]]; then
        ...
        # dockerComposeUrl="https://ghproxy.com/https://github.com/docker/compose/releases/download/v${versionDockerCompose}/docker-compose-$(uname -s)-$(uname -m)"
        dockerComposeUrl="https://ghproxy.com/https://github.com/docker/compose/releases/download/v2.9.0/docker-compose-linux-x86_64"
...
function installJitsiMeetByDocker(){
    ...
    downloadAndUnzip "https://ghproxy.com/https://github.com/jitsi/docker-jitsi-meet/archive/refs/tags/${versionJitsiMeet}.zip" "${configJitsiMeetProjectPath}" "${versionJitsiMeet}.zip"

    # https://ghproxy.com/https://github.com/jitsi/docker-jitsi-meet/archive/refs/tags/stable-7439-2.zip
