...
function installSoftOhMyZsh(){
    ...
    if [[ ! -d "${HOME}/.oh-my-zsh/custom/plugins/zsh-autosuggestions" ]] ;  then
        git clone "https://ghproxy.com/https://github.com/zsh-users/zsh-autosuggestions" "${HOME}/.oh-my-zsh/custom/plugins/zsh-autosuggestions"
...
function installWireguard(){
    bash <(wget -qO- https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/install_kernel.sh)
    # wget -N --no-check-certificate https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/install_kernel.sh && chmod +x ./install_kernel.sh && ./install_kernel.sh
}
...
function vps_netflix(){
    ...
    # bash <(curl -sSL "https://ghproxy.com/https://github.com/CoiaPrant/Netflix_Unlock_Information/raw/main/netflix.sh")
    # bash <(curl -L -s https://raw.githubusercontent.com/lmc999/RegionRestrictionCheck/main/check.sh)

	# wget -N --no-check-certificate https://ghproxy.com/https://github.com/CoiaPrant/Netflix_Unlock_Information/raw/main/netflix.sh && chmod +x netflix.sh && ./netflix.sh
    # wget -N --no-check-certificate -O netflixcheck https://ghproxy.com/https://github.com/sjlleo/netflix-verify/releases/download/2.61/nf_2.61_linux_amd64 && chmod +x ./netflixcheck && ./netflixcheck -method full

	wget -N --no-check-certificate -O ./netflix.sh https://ghproxy.com/https://github.com/CoiaPrant/MediaUnlock_Test/raw/main/check.sh && chmod +x ./netflix.sh && ./netflix.sh
}

function vps_netflix2(){
	wget -N --no-check-certificate -O ./netflix.sh https://ghproxy.com/https://github.com/lmc999/RegionRestrictionCheck/raw/main/check.sh && chmod +x ./netflix.sh && ./netflix.sh
}
...
function vps_netflixgo(){
    wget -qN --no-check-certificate -O netflixGo https://ghproxy.com/https://github.com/sjlleo/netflix-verify/releases/download/v3.1.0/nf_linux_amd64 && chmod +x ./netflixGo && ./netflixGo
    # wget -qN --no-check-certificate -O netflixGo https://ghproxy.com/https://github.com/sjlleo/netflix-verify/releases/download/2.61/nf_2.61_linux_amd64 && chmod +x ./netflixGo && ./netflixGo -method full
    echo
    echo
    wget -qN --no-check-certificate -O disneyplusGo https://ghproxy.com/https://github.com/sjlleo/VerifyDisneyPlus/releases/download/1.01/dp_1.01_linux_amd64 && chmod +x ./disneyplusGo && ./disneyplusGo
}
...
function vps_superspeed(){
    ...
    # https://ghproxy.com/https://github.com/coolaj/sh/blob/main/speedtest.sh
...
function vps_bench_dedicated(){
    # bash -c "$(wget -qO- https://ghproxy.com/https://github.com/Aniverse/A/raw/i/a)"
...
function vps_returnroute(){
    ...
    # https://ghproxy.com/https://github.com/zhucaidan/mtr_trace
...
function getTrojanAndV2rayVersion(){
    # https://ghproxy.com/https://github.com/trojan-gfw/trojan/releases/download/v1.16.0/trojan-1.16.0-linux-amd64.tar.xz
...
function getHTTPSCertificateWithAcme(){
    ...
    if [[ "$isDomainSSLFromLetInput" == "2" ]]; then
        ...
        yellow " 具体可参考 https://ghproxy.com/https://github.com/acmesh-official/acme.sh/wiki/Google-Public-CA"
        getHTTPSCertificateInputEmail
    ...
    if [[ $isAcmeSSLRequestMethodInput == [Yy] ]]; then
        ...
        if [[ ${acmeSSLHttpWebrootMode} == "standalone" ]] ; then
            ...
            # https://ghproxy.com/https://github.com/m3ng9i/ran/issues/10

            ranDownloadUrl="https://ghproxy.com/https://github.com/m3ng9i/ran/releases/download/v0.1.6/ran_linux_amd64.zip"
            ranDownloadFileName="ran_linux_amd64"

            if [[ "${osArchitecture}" == "arm64" || "${osArchitecture}" == "arm" ]]; then
                ranDownloadUrl="https://ghproxy.com/https://github.com/m3ng9i/ran/releases/download/v0.1.6/ran_linux_arm64.zip"
...
EOF
    ...
    downloadAndUnzip "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/website2.zip" "${configWebsitePath}" "website2.zip"


    if [ "${configInstallNginxMode}" != "trojanWeb" ] ; then
        wget -P "${configWebsiteDownloadPath}" "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/trojan-mac.zip"
        wget -P "${configWebsiteDownloadPath}" "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/v2ray-windows.zip"
        wget -P "${configWebsiteDownloadPath}" "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/v2ray-mac.zip"
    fi


    # downloadAndUnzip "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/trojan_client_all.zip" "${configWebsiteDownloadPath}" "trojan_client_all.zip"
    # downloadAndUnzip "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/trojan-qt5.zip" "${configWebsiteDownloadPath}" "trojan-qt5.zip"
    # downloadAndUnzip "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/v2ray_client_all.zip" "${configWebsiteDownloadPath}" "v2ray_client_all.zip"

    #wget -P "${configWebsiteDownloadPath}" "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/v2ray-android.zip"
...
function downloadTrojanBin(){
    ...
    if [ "${isTrojanGo}" = "no" ] ; then
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/trojan-gfw/trojan/releases/download/v${versionTrojan}/${downloadFilenameTrojan}" "${tempDownloadTrojanPath}" "${downloadFilenameTrojan}"
    else
        if [ -z $1 ]; then
        ...
        # https://ghproxy.com/https://github.com/p4gefau1t/trojan-go/releases/download/v0.10.6/trojan-go-linux-amd64.zip
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/p4gefau1t/trojan-go/releases/download/v${versionTrojanGo}/${downloadFilenameTrojanGo}" "${tempDownloadTrojanPath}" "${downloadFilenameTrojanGo}"
    fi
}
...
EOF
    ...
    downloadAndUnzip "https://ghproxy.com/https://github.com/jinwyp/one_click_script/raw/master/download/trojan-win-cli.zip" "${configTrojanBasePath}" "trojan-win-cli.zip"

    if [ "$isTrojanGo" = "no" ] ; then
        downloadAndUnzip "https://ghproxy.com/https://github.com/trojan-gfw/trojan/releases/download/v${versionTrojan}/trojan-${versionTrojan}-win.zip" "${configTrojanBasePath}/trojan-win-cli-temp" "trojan-${versionTrojan}-win.zip"
    ...
    if [ "$isTrojanGo" = "yes" ] ; then
        downloadAndUnzip "https://ghproxy.com/https://github.com/p4gefau1t/trojan-go/releases/download/v${versionTrojanGo}/trojan-go-windows-amd64.zip" "${configTrojanBasePath}/trojan-win-cli-temp" "trojan-go-windows-amd64.zip"
...
EOF
    ...
    yellow "3 Android 客户端下载 https://ghproxy.com/https://github.com/trojan-gfw/igniter/releases "
    yellow "  Android 另一个客户端下载 https://ghproxy.com/https://github.com/2dust/v2rayNG/releases "
    yellow "  Android 客户端Clash下载 https://ghproxy.com/https://github.com/Kr328/ClashForAndroid/releases "
    ...
    yellow "  iOS 安装小火箭遇到问题 教程 https://ghproxy.com/https://github.com/shadowrocketHelp/help/ "
    green "======================================================================"
	green "教程与其他资源:"
	...
	green "https://ghproxy.com/https://github.com/Qv2ray/Qv2ray/releases (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/Dr-Incognito/V2Ray-Desktop/releases (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/Fndroid/clash_for_windows_pkg/releases"
	green "======================================================================"
	green "其他 Mac 客户端:"
	green "https://dl.trojan-cdn.com/trojan (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/Qv2ray/Qv2ray/releases (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/Dr-Incognito/V2Ray-Desktop/releases (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/JimLee1996/TrojanX/releases (exe为Win客户端, dmg为Mac客户端)"
	green "https://ghproxy.com/https://github.com/yichengchen/clashX/releases "
	green "======================================================================"
	green "其他 Android 客户端:"
	green "https://ghproxy.com/https://github.com/trojan-gfw/igniter/releases "
	green "https://ghproxy.com/https://github.com/Kr328/ClashForAndroid/releases "
	green "======================================================================"
...
function downloadV2rayXrayBin(){
    ...
    if [ "$isXray" = "no" ] ; then
        # https://ghproxy.com/https://github.com/v2fly/v2ray-core/releases/download/v4.41.1/v2ray-linux-64.zip
        # https://ghproxy.com/https://github.com/v2fly/v2ray-core/releases/download/v4.41.1/v2ray-linux-arm32-v6.zip
        # https://ghproxy.com/https://github.com/v2fly/v2ray-core/releases/download/v4.44.0/v2ray-linux-arm64-v8a.zip
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/v2fly/v2ray-core/releases/download/v${versionV2ray}/${downloadFilenameV2ray}" "${tempDownloadV2rayPath}" "${downloadFilenameV2ray}"

    else
        # https://ghproxy.com/https://github.com/XTLS/Xray-core/releases/download/v1.5.0/Xray-linux-64.zip
        # https://ghproxy.com/https://github.com/XTLS/Xray-core/releases/download/v1.5.2/Xray-linux-arm32-v6.zip
        if [[ ${osArchitecture} == "arm" ]] ; then
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/XTLS/Xray-core/releases/download/v${versionXray}/${downloadFilenameXray}" "${tempDownloadV2rayPath}" "${downloadFilenameXray}"
    fi
}
...
function generateVmessImportLink(){
    # https://ghproxy.com/https://github.com/2dust/v2rayN/wiki/%E5%88%86%E4%BA%AB%E9%93%BE%E6%8E%A5%E6%A0%BC%E5%BC%8F%E8%AF%B4%E6%98%8E(ver-2)
...
function generateVLessImportLink(){
    # https://ghproxy.com/https://github.com/XTLS/Xray-core/discussions/716
...
# More discussion at https://ghproxy.com/https://github.com/v2ray/v2ray-core/issues/1011
User=root
#User=nobody
...
EOF
    ...
    yellow "2 MacOS 客户端下载：http://${configSSLDomain}/download/${configTrojanWindowsCliPrefixPath}/v2ray-mac.zip"
    yellow "3 Android 客户端下载 https://ghproxy.com/https://github.com/2dust/v2rayNG/releases"
...
function downloadTrojanWebBin(){
    # https://ghproxy.com/https://github.com/Jrohy/trojan/releases/download/v2.12.2/trojan-linux-amd64
    # https://ghproxy.com/https://github.com/Jrohy/trojan/releases/download/v2.12.2/trojan-linux-arm64
    ...
    if [ -z $1 ]; then
        wget -O ${configTrojanWebPath}/trojan-web --no-check-certificate "https://ghproxy.com/https://github.com/Jrohy/trojan/releases/download/v${versionTrojanWeb}/${downloadFilenameTrojanWeb}"
    else
        wget -O ${configDownloadTempPath}/upgrade/trojan-web/trojan-web "https://ghproxy.com/https://github.com/Jrohy/trojan/releases/download/v${versionTrojanWeb}/${downloadFilenameTrojanWeb}"
    fi
}
...
Documentation=https://ghproxy.com/https://github.com/Jrohy/trojan
...
function downloadMosdns(){
    ...
    if [[ "${isInstallMosdns}" == "true" ]]; then
        ...
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns/releases/download/v3.8.0/mosdns-linux-amd64.zip
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns/releases/download/v3.8.0/mosdns-linux-arm64.zip
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns/releases/download/v3.8.0/mosdns-linux-arm-7.zip
        if [[ ${osArchitecture} == "arm" ]] ; then
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/IrineSistiana/mosdns/releases/download/v${versionMosdns}/${downloadFilenameMosdns}" "${configMosdnsPath}" "${downloadFilenameMosdns}"
        ...
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns-cn/releases/download/v1.2.3/mosdns-cn-linux-amd64.zip
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns-cn/releases/download/v1.2.3/mosdns-cn-linux-arm64.zip
        # https://ghproxy.com/https://github.com/IrineSistiana/mosdns-cn/releases/download/v1.2.3/mosdns-cn-linux-arm-7.zip
        if [[ ${osArchitecture} == "arm" ]] ; then
        ...
        downloadAndUnzip "https://ghproxy.com/https://github.com/IrineSistiana/mosdns-cn/releases/download/v${versionMosdnsCn}/${downloadFilenameMosdnsCn}" "${configMosdnsPath}" "${downloadFilenameMosdnsCn}"
